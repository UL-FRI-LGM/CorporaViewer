...
var getById = async (req, res) => {
    ...
    const path = (process.env.PATH_TO_ROOT || '/home/martin/Dipl/dihur-kranjska') + `/api/data/Kranjska-pdf/${filename}.pdf`
...
var getThumbnailById = async (req, res) => {
    ...
    const path = (process.env.PATH_TO_ROOT || '/home/martin/Dipl/dihur-kranjska') + `/api/data/thumbnails/${filename}.png`;
